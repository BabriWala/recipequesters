...
exports.refreshToken = exports.getAllUsers = exports.buyCoins = exports.getUserDetails = exports.registerUser = void 0;
...
const refreshToken = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        const decoded = jsonwebtoken_1.default.verify(refreshToken, process.env.TOKEN);
        const userId = decoded.user.id;
        const user = yield User_1.default.findById(userId);
