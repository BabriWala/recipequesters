...
exports.findSimilarRecipesByCategory =
  exports.updateRecipeReactions =
...
const createRecipe = (req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
      ...
      const imgBBResponse = yield (0, recipeUtils_1.uploadImageToImgBB)(
        imageUrl
      );
      const imgBBUrl = imgBBResponse.data.data.url;
      // Create the recipe with the creator's email and ImgBB URL
      const recipe = yield (0, recipeUtils_1.createNewRecipe)(
        user.email,
        imgBBUrl,
        details,
        country,
...
const getRecipes = (req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
      ...
      const recipes = yield Reciepe_1.default
        .find(query)
  ...
  __awaiter(void 0, void 0, void 0, function* () {
    try {
      ...
      if (tokenData) {
        // @ts-ignore
        const { id: userId } =
          tokenData === null || tokenData === void 0 ? void 0 : tokenData.user;
        const { email: userEmail, displayName: userDisplayName } = yield (0,
        userUtils_1.getUserDetails)(userId);
        yield (0, recipeUtils_1.updateRecipeViews)(
          recipe,
          userId,
          userEmail,
          userDisplayName
        );
        yield (0, recipeUtils_1.updateCoins)(
          userId,
          userEmail,
          recipe.creatorEmail
        );
...
const updateRecipeReactions = (req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    var _c;
    ...
    try {
      // Verify token
      const token =
        (_c = req.headers["Authorization"]) === null || _c === void 0
          ? void 0
          : _c.replace("Bearer ", "");
      if (!token) {
...
const findSimilarRecipesByCategory = (req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const recipeId = req.params.id;
    try {
      const recipe = yield Reciepe_1.default.findById(recipeId);
      ...
      const similarRecipes = yield Reciepe_1.default
        .find({
